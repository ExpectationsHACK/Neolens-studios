...
type AnimationMode = "auto" | "drag" | "scroll" | "all";
...
const InfiniteSpiral = ({
  ...
  const normalizedItems = useMemo<Required<SpiralItem>[]>(
    () =>
      items.map((item, index) =>
        typeof item === "string"
          ? {
              src: item,
              alt: `Spiral video ${index + 1}`,
              href: "",
              target: "",
              label: "",
              id: "",
  ...
  return (
    ...
    >
      <div className="infinite-spiral__stage" role="list" aria-label="Behind-the-scenes video gallery">
